...
- A terminal that supports 256-color ANSI (the statusline uses `\033[38;5;Nm` escapes — see the color variable definitions in [`../plugins/conscientious/hooks/conscientious-statusline.sh`](../plugins/conscientious/hooks/conscientious-statusline.sh)).
